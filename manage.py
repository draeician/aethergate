...
async def add_model_logic(
    ...
    async for session in get_session():
        ...
        print(f"Price: ${price_in}/in, ${price_out}/out")
...
def add_model(
    ...
    """
    Map a public model name to a backend provider and set price.
    Example: add-model qwen2.5:3b ollama/qwen2.5:3b --price-in 0.01
    """
